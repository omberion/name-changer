package dev.minetomek.namechanger.client.mixin;
...
public abstract class SocialInteractionsPlayerListMixin extends ContainerObjectSelectionList<PlayerEntry> {
    @Final
    @Shadow
    private SocialInteractionsScreen socialInteractionsScreen;

    public SocialInteractionsPlayerListMixin(Minecraft minecraft, int width, int height, int y, int itemHeight) {
